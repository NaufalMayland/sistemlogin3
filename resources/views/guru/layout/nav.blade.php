<div class="relative">
    ...
    <div class="w-64 bg-blue-700 text-white min-h-screen fixed left-0 top-0 z-50">
        ...
        <nav class="mt-6 pr-10">
            <ul>
                @if ($guruwali or $gurumapel)
                    <li>
                        <a href="/siswa" class="flex items-center text-sm font-semibold mb-2 py-2.5 pl-6 rounded-r-[5rem] transition duration-300 ease-in-out hover:bg-slate-100 hover:text-blue-700">
                            <i class="fa-solid fa-bars-progress text-xl mr-3"></i>Mata Pelajaran
                        </a>
                    </li>
                    <li>
                        <a href="/raport" class="flex items-center text-sm font-semibold mb-2 py-2.5 pl-6 rounded-r-[5rem] transition duration-300 ease-in-out hover:bg-slate-100 hover:text-blue-700">
        ...
        <div class="mt-6 text-center">
            <a href="/" class="text-sm border font-semibold rounded-full py-2.5 px-8 transition duration-200 ease-in-out hover:border-0 hover:bg-slate-100 hover:text-blue-700">Logout</a>
        </div>
    </div>
</div>